...
const Categories = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 py-6 px-12 bg-black'>
           {
            ...
            <div className="card-body">
                <h2 className="card-title bg-red-600 text-xl uppercase mx-auto p-2">Brand: {category.Brand}</h2>
            </div>
        </Link>)
           }
